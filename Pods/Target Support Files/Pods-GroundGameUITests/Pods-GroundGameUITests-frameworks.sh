...
if [[ "$CONFIGURATION" == "DebugStaging" ]]; then
  ...
  install_framework "Pods-GroundGameUITests/Facebook_iOS_SDK.framework"
  ...
  install_framework "Pods-GroundGameUITests/Realm.framework"
  install_framework "Pods-GroundGameUITests/RealmSwift.framework"
