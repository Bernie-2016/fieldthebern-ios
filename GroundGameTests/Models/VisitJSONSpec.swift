    ...
    override func spec() {
        ...
        describe("VisitJSON") {
            ...
            describe("with just one person") {
                ...
                beforeEach {
                    person1 = Person(firstName: "Josh", lastName: "Smith", partyAffiliation: "Democrat", canvass_: CanvassResponse.LeaningFor)
            ...
            describe("with more than one person") {
                ...
                beforeEach {
                    person1 = Person(firstName: "Josh", lastName: "Smith", partyAffiliation: "Democrat", canvass_: CanvassResponse.LeaningFor)
                    person2 = Person(firstName: "Molly", lastName: "Smith", partyAffiliation: "Democrat", canvass_: CanvassResponse.LeaningFor)
                    address = Address(latitude: 32.752768, longitude: -117.116992, street1: "4166 Wilson Ave", street2: "1", city: "San Diego", stateCode: "CA", zipCode: "92104", result: .NotHome)
